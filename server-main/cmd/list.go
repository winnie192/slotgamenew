...
func init() {
	...
	listflags.Bool("slotgame", false, "include games of this 'slotgame' provider")
	...
	listCmd.MarkFlagsOneRequired("all",
		"agt", "aristocrat", "betsoft", "igt", "megajack", "netent", "novomatic", "playngo", "playtech", "slotgame", "keno",
